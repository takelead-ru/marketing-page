        ...
        <div class="flex flex-col justify-center items-center | md:flex-row">
            ...
            <form x-data="subscribeForm()" x-on:submit.prevent="submit" action="" method="post" class="relative | w-full max-w-sm">
                <div class="h-12 pl-5 pr-24 bg-white rounded-full | flex justify-between items-center">
                    ...
                    <input type="email" id="email" class="text-indigo-700 text-lg leading-5 w-full pr-2 | focus:outline-none"
                           placeholder="your@email.com" x-model="email">

                    <button
                            class="absolute right-0 mr-1 | px-4 py-2 | text-white font-semibold rounded-full | focus:outline-none | disabled:opacity-75 disabled:cursor-not-allowed"
